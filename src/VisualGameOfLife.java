...
/**CanvasInt: Die Klasse zum erstellen einer grafischen Oberfläche für Game of life*/
class CanvasInt extends Canvas {
	...
	/*
	Von Emmanuel eingebaut
	 */
	Color[] colerArray = {Color.BLUE, Color.RED, Color.YELLOW};
...
@SuppressWarnings("serial")
/**VisualGameOfLife: Die Klasse nimmt das gezeichnet Feld von CanvasInt und packt es in ein  Fenster.*/
